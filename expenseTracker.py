...
def submitexpense():
    values=[dateEntry.get(),Category.get(),Title.get(),Expense.get()]
    print(values)
    ...
    (?, ?, ?, ?)
    '''
    curr.execute(query,(dateEntry.get(),Category.get(),Title.get(),Expense.get()))
    connectionObjn.commit()
...
def viewexpense():
    ...
    l=Label(root,text="Date\t  Category\t  Title\t  Expense",font=('arial',15,'bold'),bg="DodgerBlue2",fg="white")
...
Category=StringVar()
categoryLabel=Label(root, text="Category",font=('arial',15,'bold'),bg="DodgerBlue2",fg="white",width=12)
categoryLabel.grid(row=1,column=0,padx=7,pady=7)

CategoryEntry=Entry(root,textvariable=Category,font=('arial',15,'bold'))
CategoryEntry.grid(row=1,column=1,padx=7,pady=7)
...
submitbtn=Button(root,command=submitexpense,text="Submit",font=('arial',15,'bold'),highlightbackground="DodgerBlue2",fg="black",width=12 )
submitbtn.grid(row=4,column=0,padx=13,pady=13)

viewtn=Button(root,command=viewexpense,text="View expenses",font=('arial',15,'bold'),highlightbackground="DodgerBlue2",fg="white",width=12 )
viewtn.grid(row=4,column=1,padx=13,pady=13)

# all saved expenses--------------
Elist=['Date','Category','Title','Expense']
